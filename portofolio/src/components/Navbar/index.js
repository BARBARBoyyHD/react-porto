    ...
    <Nav>
      <NavContainer>
        <NavLogo to="/">
          ...
          >
            <DiCssdeck size ="3rem"/><Span>Welcome to my Portfolio !</Span>
          </a>
        </NavLogo>
        <MobileIcon>
          <FaBars
        ...
        <ButtonContainer>
          <GithubButton><a href='https://github.com/BARBARBoyyHD' style={{textDecoration: 'none'}}>Github Profile</a>   </GithubButton>
        </ButtonContainer>
      </NavContainer>
      {
        open && (
